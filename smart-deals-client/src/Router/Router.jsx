...
export const router = createBrowserRouter([
  ...
  {
    path: "/allproduct",
    element: <PrivetRouter><AllProducat></AllProducat></PrivetRouter>,
  },
  {
    path: "/myproducat",
    element: <PrivetRouter><MyProducat></MyProducat></PrivetRouter>,
  },
  {
    path: "/mybids",
  ...
  {
    path: "/creatProducat",
    element: <PrivetRouter><CreatProducat></CreatProducat></PrivetRouter>,
  },
]);
