...
const FoodDetlics = () => {
  ...
  const producatshfsfjs = (e) => {
    ...
    fetch("http://localhost:4000/price", {
      ...
      .then((res) => res.json())
      .then((data) => {
        console.log("Bides Data Saved On mongoDb", data);
        if (data.insertedId) {
      ...
      <div className="bg-base-200 py-15">
            ...
            <div className="space-y-6 pt-10">
              ...
              <div className=" ">
                ...
                <div className="border bg-white p-4 border-base-300 rounded-lg shadow">
                  ...
                  <p className="font-semibold text-gray-700  flex items-center gap-2">
                    Posted :<span className="text-[14px] ">{formary}</span>
                  </p>
                </div>
              </div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex">
                      <span className="font-semibold text-gray-700  flex gap-2">
                        Location: <span>{producat.shoplocation}</span>
                      </span>
              ...
              >
                <div className="modal-box">
                  ...
                  <form onSubmit={producatshfsfjs} className="space-y-6">
        ...
        <div className="py-20">
          <h2 className="text-3xl font-semibold text-purple-600 mt-2">
            Bids For This Products: {dats?.length}
          </h2>
